...
const dotStyles: Record<DeliveryStatus, string> = {
...
export default function StatusBadge({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 rounded-full border font-semibold ${statusStyles[status]} ${sizeClasses}`}
    >
